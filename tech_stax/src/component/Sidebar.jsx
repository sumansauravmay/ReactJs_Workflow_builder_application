...
export default () => {
  ...
  return (
    <aside>
      ...
      <div className="dndnode output" onDragStart={(event) => onDragStart(event, 'Wait')} draggable>
        Wait
      </div>

      <div className="dndnode output" onDragStart={(event) => onDragStart(event, 'Convert Formate')} draggable>
        Convert Formate
      </div>

<div className="dndnode output" onDragStart={(event) => onDragStart(event, 'Send Post Request')} draggable>
        Send Post Request
      </div>
